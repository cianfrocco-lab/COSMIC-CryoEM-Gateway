...
ssh cosmic2@comet.sdsc.edu \
	"source ~/.bashrc; cd tgusage_${HOSTNAME}; cipres-tgusage -j --username=cosmic2 --begindate=$BEGIN --enddate=$END > tgusage_report.txt"
scp cosmic2@comet.sdsc.edu:tgusage_${HOSTNAME}/tgusage_report.txt .
