...
public class Transfer2DataManager extends NgbwSupport
{
        ...
        String destination_path, Folder folder )
    {
        ...
        for ( String transferred_dir : transferred_dirs )
        {
            ...
            //log.debug ( "MONA : dir getTotalSpace = " + dir.getTotalSpace() );
            //log.debug ( "MONA : dir sizeOf = " + FileUtils.sizeOf ( dir ) );
            //log.debug ( "MONA : dir sizeOfDirectory = " + FileUtils.sizeOfDirectory ( dir ) );
